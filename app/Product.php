...
{
    protected $fillable = ['category_id','sub_category_id','product_name','product_brief','product_description','product_price','quantity','condition','brand_name','product_file'];
